...
namespace HolaMundoForms.Catalogos
{
    public partial class frmProductos : Form
    {
        ...
        {             
            ...
            oProducto.Cod_producto = this.txtCodigo.Text.Trim();
            oProducto.Nombre = this.txtNombre.Text.Trim();
            oProducto.Precio = (double)this.numericUpDown1.Value;
            oProducto.Costo = (double)this.numericUpDown2.Value;
            oProducto.Fecha_ingreso = this.dateTimePicker1.Value;   
