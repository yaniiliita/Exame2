...
namespace HolaMundoForms.Catalogos
{
    public partial class frmClientes : Form
    {
        ...
        public void ENVIAR_DATOS_NUEVO_REGISTRO()
        {
            ...
            cat_cliente oCliente = new cat_cliente();
            ...
            oCliente.Razon_social = this.txtRazonSocial.Text.Trim();
            oCliente.Rfc = this.txtRfc.Text.Trim();
            oCliente.Calle = this.txtCalle.Text.Trim();
            oCliente.Num_ext = this.txtNumExt.Text.Trim();
            oCliente.Num_int = this.txtNumInt.Text.Trim();
            oCliente.Referencia = this.txtReferencia.Text.Trim();
            oCliente.Colonia = this.txtColonia.Text.Trim();
            oCliente.Estado = this.txtEstado.Text.Trim();
            oCliente.Codigo_postal = this.txtCodPostal.Text.Trim();
            oCliente.Municipio = this.txtMunicipio.Text.Trim();
            oCliente.Tel = this.txtTelefono.Text.Trim();
            oCliente.Correo = this.txtEmail.Text.Trim();
